...
Чат поддержавших **exteraGram** — модифицированного Telegram-клиента — активно разрабатывало расширения для клиента. В один момент кто-то из чата создал плагин, который позволял визуально имитировать баланс в Звёздах, TON и Подарки.
